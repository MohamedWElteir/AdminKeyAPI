...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "AdminKeyAPI", Version = "v1" });
});
...
{
    options.AddBasePolicy(x => x.Expire(TimeSpan.FromSeconds(54)));
});
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "AdminKeyAPI v1");
    });
}else
{
